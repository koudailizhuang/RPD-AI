...
parser.add_argument('--model-path', type=str, default=ROOT / 'runs/train-seg/exp15/weights/best.pt', help='Path to the model')
parser.add_argument('--img-path', type=str, default=ROOT / 'data/640_200', help='input image path')
parser.add_argument('--output-dir', type=str, default=ROOT / 'runs/gradcam_map/exp15_', help='output dir')
