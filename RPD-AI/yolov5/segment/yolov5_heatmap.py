...
def get_params():
    params = {
        'weight': 'E:/Doc.Zheng/data_algorithm/yolov5-v7.0-2/weight/best.pt',
        'cfg': 'E:/Doc.Zheng/data_algorithm/yolov5-v7.0-2/models/segment/yolov5n-seg.yaml',
        'device': 'cuda:0',
...
if __name__ == '__main__':
    ...
    model('E:/Doc.Zheng/data_algorithm/yolov5-v7.0-2/segment/1.JPG', 'E:/Doc.Zheng/data_algorithm/yolov5-v7.0-2/segment/results')
