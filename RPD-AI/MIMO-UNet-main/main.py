...
if __name__ == '__main__':
    ...
    parser.add_argument('--data_dir', type=str, default='D://algorithm//datasets//SiAl')
    ...
    # Test
    parser.add_argument('--test_model', type=str, default='weights/Best.pkl')
    parser.add_argument('--save_image', type=bool, default=True, choices=[True, False])

    args = parser.parse_args()
    args.model_save_dir = os.path.join('results/', args.model_name, 'weights/')
    args.result_dir = os.path.join('results/', args.model_name, 'result_image/output/')
    print(args)
    main(args)
